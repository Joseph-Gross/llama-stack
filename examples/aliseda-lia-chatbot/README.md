...
This project demonstrates how to build a custom Language Intelligence Assistant (LIA) chatbot for a real estate company (Aliseda Inmobiliaria) using the Llama Stack framework.
...
```
aliseda-lia-chatbot/
├── aliseda_backend/           # FastAPI backend
│   ├── app/
│   │   ├── main.py            # Main FastAPI application
│   │   ├── models/            # Pydantic models
│   │   ├── routers/           # API endpoints
│   │   └── services/          # Business logic and Llama Stack integration
│   ├── .env                   # Environment variables
│   └── pyproject.toml         # Poetry dependencies
│
└── aliseda_frontend/          # React frontend
    ├── src/
